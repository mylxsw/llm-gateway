        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 gap-3 text-sm sm:grid-cols-2 lg:grid-cols-4">
            <div className="flex items-start gap-2">
              ...
              <div className="min-w-0">
                <div className="text-muted-foreground">{t('detail.requestTime')}</div>
                <div
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="min-w-0">
                <div className="text-muted-foreground">{t('detail.apiKey')}</div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="min-w-0">
                <div className="text-muted-foreground">{t('detail.modelMapping')}</div>
          ...
          <div className="rounded-lg border bg-muted/30 p-3">
            <div className="mb-2 text-sm font-medium">{t('detail.metrics')}</div>
            <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm sm:grid-cols-3 lg:grid-cols-7">
              <div className="flex items-center justify-between gap-2">
                <span className="text-muted-foreground">{t('detail.ttfb')}</span>
              ...
              <div className="flex items-center justify-between gap-2">
                <span className="text-muted-foreground">{t('detail.input')}</span>
                <span className="font-medium">{log.input_tokens ?? 0}</span>
              </div>
              <div className="flex items-center justify-between gap-2">
                <span className="text-muted-foreground">{t('detail.output')}</span>
                <span className="font-medium">{log.output_tokens ?? 0}</span>
              </div>
              <div className="flex items-center justify-between gap-2">
                <span className="text-muted-foreground">{t('detail.retries')}</span>
              ...
              >
                <span className="text-muted-foreground">{t('detail.cost')}</span>
          ...
          {tokenUsageItems.length > 0 && (
            <div className="rounded-lg border bg-muted/30 p-3">
              <div className="mb-2 text-sm font-medium">{t('detail.tokenUsageDetails')}</div>
          ...
          <div className="rounded-lg border bg-muted/30 p-3">
            <div className="mb-2 text-sm font-medium">{t('detail.requestFlow')}</div>
            <div className="flex flex-wrap items-center gap-2 text-sm">
              <div className="inline-flex items-center rounded-md border bg-background px-2 py-1">
                <span className="text-muted-foreground">{t('detail.apiKey')}</span>
              ...
              <div className="inline-flex items-center rounded-md border bg-background px-2 py-1">
                ...
                <span className="ml-2 font-medium">{log.response_status ?? t('unknown')}</span>
              </div>
              {log.request_protocol && log.supplier_protocol && log.request_protocol !== log.supplier_protocol && (
                <>
                  <ArrowRight className="h-4 w-4 text-muted-foreground" suppressHydrationWarning />
                  <div className="inline-flex items-center rounded-md border bg-background px-2 py-1">
                    <span className="text-muted-foreground">{t('detail.protocol')}</span>
      ...
      <Card>
        ...
        <CardContent>
          {activeTab === 'request' && (
            <div className={layout === 'horizontal' && log.converted_request_body ? 'grid grid-cols-1 gap-6 lg:grid-cols-2' : 'space-y-6'}>
              ...
              {log.converted_request_body && (
                <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="text-sm font-medium">{t('detail.convertedRequest')}</div>
          ...
          {activeTab === 'response' && (
            <div className={layout === 'horizontal' && log.upstream_response_body ? 'grid grid-cols-1 gap-6 lg:grid-cols-2' : 'space-y-6'}>
              {log.upstream_response_body && (
                <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="text-sm font-medium">{t('detail.originalResponse')}</div>
                  {log.supplier_protocol && (
                    <Badge variant="outline" className="font-mono text-xs">
                      {log.supplier_protocol}
                    </Badge>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="text-sm font-medium">{t('detail.convertedResponse')}</div>
                  {log.request_protocol && (
                    <Badge variant="outline" className="font-mono text-xs">
                      {log.request_protocol}
                    </Badge>
          ...
          {activeTab === 'headers' && log && (
            <div className="space-y-6">
              <div className="space-y-3">
                <h3 className="text-sm font-medium">{t('detail.requestHeaders')}</h3>
                <JsonViewer data={log.request_headers || {}} />
              </div>
              <div className="space-y-3">
                <h3 className="text-sm font-medium">{t('detail.responseHeaders')}</h3>
